...
public class Contact_AssortView extends Button {
	...
	public Contact_AssortView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public Contact_AssortView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public Contact_AssortView(Context context, AttributeSet attrs, int defStyle) {
